...
export default function PermisoEdit({ permiso, entidades, acciones }: PermisoEditProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    put(route('parametros.permiso.update', permiso.id), {
      onSuccess: () => reset(),
    });
  };
  return (
