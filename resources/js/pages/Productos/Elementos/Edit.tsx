...
export default function ElementosEdit({ producto, elemento }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        nombre: elemento.nombre,
        progreso: elemento.progreso,
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/productos/${producto.id}/elementos/${elemento.id}`);
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Editar Elemento" />
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold">Editar Elemento</h1>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="progreso">Progreso Actual</Label>
                                    <Input
                                        id="progreso"
                                        type="number"
                                        value={elemento.progreso}
                                        disabled
                                        className="bg-gray-100"
                                    />
                                    <p className="text-sm text-muted-foreground">
                                        El progreso se actualiza automáticamente cuando se registran entregas de evidencia.
                                    </p>
                                </div>
                                ...
                                <div className="flex justify-end space-x-2">
                                    ...
                                    <Button type="submit" disabled={processing}>
                                        ...
                                        {processing ? 'Guardando...' : 'Actualizar Elemento'}
                                    </Button>
                                </div>
                            </form>
                        </CardContent>
